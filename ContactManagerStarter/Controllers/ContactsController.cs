...
namespace ContactManager.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> DeleteContact(Guid id)
        {
            ...
            {
                return StatusCode(500, "Error has occured in DeleteContact - " + ex.Message);
            }
        }
        ...
        public async Task<IActionResult> EditContact(Guid id)
        {
            ...
            {
                return StatusCode(400, "Error has occured in EditContact - " + ex.Message);
            }
        }
        public async Task<IActionResult> GetContacts()
        {
            ...
            {
                return StatusCode(500, "Error has occured in GetContacts - " + ex.Message);
            }
        }
        ...
        public async Task<IActionResult> SaveContact([FromBody] SaveContactViewModel model)
        {
            ...
            {
                return StatusCode(400, "Error has occured in SaveContact - " + ex.Message);
            }
        }
    }
